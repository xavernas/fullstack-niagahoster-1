...
<div class="container">
    ...
    <!-- Loading data from JSON about packages -->
    <?php 
        // Get the file
        $file_to_receive = file_get_contents('data_package.json');
        $data = json_decode($file_to_receive,true);
        
        // 
        foreach ($data['packages'] as $entity){
    ?>
            ...
            <table>
                ...
                <tr>
                    <td class="content-fourth-old-price">
                        <del>Rp. 
                        <?=
                        number_format($entity['old_price'], 0, '', '.')
                        ?>                        
                        <del>
                    </td>
                </tr>
                <tr>
                    <td class="content-fourth-new-price">
                        <?php
                        $converted=strval(number_format($entity['new_price'], 0, '', '.'));
                        $pieces = explode(".", $converted);
                        ?> 
                        Rp. <span>
                        <?= $pieces[0] ?></span>.<?=$pieces[1]?> / bln
                    </td>
                </tr>
                <tr>
                    <td class="content-fourth-user-register">
                        <?=
                        number_format($entity['user_register'], 0, '', '.')
                        ?>                        
                ...
                <tr>
                    <td class="content-fourth-detail">
                        <?php foreach ($entity['benefit'] as $benefit_point){?>
                        <?= $benefit_point ?><br>
                        <?php }?>
